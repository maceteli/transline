...
@section('scripts')
    ...
    <script type="text/jsx">
		...
		var SwitchState = React.createClass({
			...
			render: function(){
				...
				if(this.props.checkState != ""){
					...
					}else if((this.props.checkState.status == 'DROPPED' || this.props.checkState.status == 'COMPLETED') && this.props.checkState.payment_mode == 'PAYSTACK' && this.props.checkState.paid == 0){
						return (
							<div>
								<DroppedAndPaystack checkState={this.props.checkState} currency={this.props.currency} />
							</div>
						);
					}else if(this.props.checkState.status == 'COMPLETED'){
						return (
		...
		var DroppedAndPaystack = React.createClass({
                    ...
                    <dl className="dl-horizontal left-right">
                       <dt>@lang('user.ride.base_price')</dt>
                        ...
                        <dd className="big">{this.props.currency}{this.props.checkState.payment.total}</dd>
                            ...
                            <input type="hidden" name="email" value={this.props.checkState.user.email} />
                            <input type="hidden" name="amount" value={this.props.checkState.payment.total * 100} />
