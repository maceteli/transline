        ...
        $.get('/dispatcher/dispatcher/providers', { 
            ...
            console.log('Providers', result);
             if(result.length>0) {
                ...
                window.assignProviderShow(result, this.props.trip);
            } else {
                this.setState({
                    data: {
                        data: []
    ...
    render() {
        ...
        return (
            <div className="card">
                ...
                <DispatcherAssignListItem data={this.state.data} trip={this.props.trip} />
            </div>
        );
    }
}
...
class DispatcherAssignListItem extends React.Component {
    ...
    render() {
        console.log('data---',Array.isArray(this.props.data));
